...
/**
 * Provider logos used across the homepage Comparison table column
 * headers, the LocalFirst provider strip, and the Hero TrustedBy
 * marquee. Each logo accepts the full set of SVG props so callers
 * can forward `aria-hidden`, `role`, `focusable`, etc. when the
 * logo is paired with visible text and the SVG should not be
 * announced as a separate element by assistive tech.
 */
type LogoProps = React.SVGProps<SVGSVGElement>;

// Anthropic, A mark
export const AnthropicLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
...
// OpenAI, knot mark
export const OpenAILogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
// Google, G mark
export const GoogleLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
// Meta, infinity mark
export const MetaLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
...
// Mistral, pixel grid
export const MistralLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
// Cohere, C arc
export const CohereLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" {...rest}>
    <path d="M17 7A7 7 0 1 0 17 17"/>
  </svg>
);

// xAI, stylized x letterform
export const XAILogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
export const DeepSeekLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
...
// Microsoft, 4 squares
export const MicrosoftLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" {...rest}>
...
// Qwen, stylized Q
export const QwenLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...rest}>
...
export const OllamaLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...rest}>
...
export const LMStudioLogo = ({ className = "w-5 h-5", ...rest }: LogoProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...rest}>
...
// Map provider name to component. Type widened to React.FC<LogoProps>
// so consumers can forward arbitrary SVG props through the marquee
// or table-cell shells.
