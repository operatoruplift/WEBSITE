        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <TechCard className="h-full">
                <div className="p-8 md:p-12 relative z-10 flex flex-col h-full">
                    ...
                    <a href="https://help.operatoruplift.com/core-concepts" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-3 py-1.5 rounded-md text-[10px] font-bold uppercase tracking-widest mb-6 w-fit hover:bg-emerald-500/20 transition-colors">
