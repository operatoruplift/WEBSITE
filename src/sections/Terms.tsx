    ...
    <section className="w-full min-h-screen bg-background pt-32 pb-24 px-6 md:px-12 flex justify-center">
      <div className="w-full max-w-[800px] text-foreground/85 space-y-8">
        ...
        <div className="space-y-6 leading-relaxed">
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">1. Acceptance of Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">3. User Responsibilities</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">4. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">5. Termination</h2>
            <p>
           ...
           <section>
            <h2 className="text-xl text-foreground font-bold mb-3">6. Limitation of Liability</h2>
            <p>
