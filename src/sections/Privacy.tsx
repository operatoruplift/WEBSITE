    ...
    <section className="w-full min-h-screen bg-background pt-32 pb-24 px-6 md:px-12 flex justify-center">
      <div className="w-full max-w-[800px] text-foreground/85 space-y-8">
        <div className="border-b border-foreground/10 pb-8 mb-12">
          ...
          <h1 className="text-4xl md:text-5xl text-foreground font-medium tracking-tight">Privacy Policy</h1>
          <p className="text-muted mt-4 font-mono text-sm">Last Updated: April 2026</p>
        </div>

        <div className="space-y-6 leading-relaxed">
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">2. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">3. Where Your Data Goes</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">4. Third-Party Services</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl text-foreground font-bold mb-3">5. Your Rights</h2>
            <p>
           ...
           <section>
            <h2 className="text-xl text-foreground font-bold mb-3">6. Contact Us</h2>
            <p>
