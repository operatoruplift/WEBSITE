...
const TEMPLATES = [
    ...
    { id: 'research', name: 'Research Agent', icon: Brain, color: 'text-[#9945FF]', desc: 'Deep research across papers, docs, and the web', capabilities: ['Papers', 'Citations', 'Summarize'] },
    { id: 'writer', name: 'Content Writer', icon: FileText, color: 'text-[#00D4FF]', desc: 'Blog posts, docs, social media, and more', capabilities: ['Blog', 'Social', 'Docs'] },
                ...
                <div className="max-w-[900px] mx-auto space-y-8">
                    ...
                    <div className="animate-fadeInUp">
                        <div className="flex items-center gap-3 mb-2">
                            <div className="w-10 h-10 rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(231,118,48,0.3)]" style={{ background: 'linear-gradient(135deg, #E77630, #9945FF)' }}>
