...
const INTEGRATIONS: Integration[] = [
    ...
    { id: 'dd_xyz', name: 'DD.xyz', description: 'Real-time risk data, due diligence reports, compliance scoring', category: 'Blockchain', icon: Shield, status: 'available', howItWorks: 'Helper queries DD.xyz APIs for risk and compliance data, used by security and compliance helpers.' },
