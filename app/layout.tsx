...
export const metadata: Metadata = {
  ...
  description: "Keep your word. Bet on yourself. Stake money on your commitments, upload proof, AI verifies. Fail and your stake redistributes to operators who kept theirs.",
