...
export default function BlogPage() {
    ...
    return (
        <div className="relative w-full bg-background min-h-screen text-foreground">
            ...
            <main id="main" className="relative z-10 pb-24 px-6 md:px-12 max-w-[1200px] mx-auto">
                ...
                {/* FadeIn defaults to `inline-block` which shrinks to
                    content width and breaks centering of the hero. The
                    `block` prop (added in the FadeIn module) switches
                    the wrapper to `block w-full` so flex + text-center
                    inside actually have the full viewport to center
                    against. PRs #572 + #573 attempted this fix at the
                    call site, but the underlying inline-block always
                    won. The fix has to be in FadeIn itself. */}
                <FadeIn block>
