    ...
    return (
        ...
        <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background text-foreground" style={{ fontFamily: '"SF Pro Display", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }}>
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute -top-1/4 -left-1/4 w-1/2 h-1/2 rounded-full bg-[#F08A4C]/8 blur-[120px]" />
                <div className="absolute -bottom-1/4 -right-1/4 w-1/2 h-1/2 rounded-full bg-[#F08A4C]/5 blur-[120px]" />
            </div>
            ...
            <div className="w-full max-w-md p-8 rounded-2xl border border-white/10 bg-black/40 backdrop-blur-xl relative z-10 shadow-2xl">
                ...
                {view === 'gate' && (
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                                <div className="flex items-center gap-2 mb-2">
                                    <Wallet size={14} className="text-[#F08A4C]" />
                                    <Badge variant="default" className="text-[8px] font-mono bg-[#F08A4C]/10 border-[#F08A4C]/20 text-[#F08A4C]">0.1 SOL</Badge>
                                </div>
                ...
                {view === 'waitlist-success' && (
                    <div className="text-center py-6">
                        ...
                        <button onClick={handleStartPayment} className="mt-2 text-sm text-[#F08A4C] hover:text-[#F08A4C]/80 transition-colors font-medium">
                ...
                {view === 'pay-pending' && (
                    <div className="space-y-5">
                        <div className="text-center">
                            <Badge variant="default" className="bg-[#F08A4C]/10 border-[#F08A4C]/20 text-[#F08A4C] text-[10px] font-mono tracking-widest mb-4 inline-flex items-center gap-1">
